...
// contract MillionsLandToken is Ownable, ERC721Enumerable {
//   uint256 public mintPrice = 1000000000000000000;  // 1AVAX
//   string private _baseUri;

//   constructor() ERC721("MillionsLandToken", "MLT") {}
...
//   // function ownedTokensArray(address owner) external view returns (uint256[] memory) {
//   //   uint256 balance = ERC721.balanceOf(owner);
//   //   uint256[] memory tokens = new uint256[](balance);
//   //   for (uint256 index = 0; index < balance; index++) {
//   //     tokens[index] = ERC721Enumerable.tokenOfOwnerByIndex(owner, index);
//   //   }
